package ru.success.MyFirstServer.config;
...
@EnableJpaRepositories("ru.success.MyFirstServer.repository")// вкл подержку jpa repository
...
@ComponentScan("ru.success.MyFirstServer") //рут пакет, где искать наши репозитории, конфиги и т.д
